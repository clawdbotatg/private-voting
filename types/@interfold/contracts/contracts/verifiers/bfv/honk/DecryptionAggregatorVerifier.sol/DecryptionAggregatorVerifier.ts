...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../../../../../../common.js"
  ...
  export interface DecryptionAggregatorVerifierInterface extends Interface {
  ...
  export interface DecryptionAggregatorVerifier extends BaseContract {
    
    connect(runner?: ContractRunner | null): DecryptionAggregatorVerifier;
    waitForDeployment(): Promise<this>;

    interface: DecryptionAggregatorVerifierInterface;
