...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../../../../../../common.js"
  ...
  export interface DkgAggregatorVerifierInterface extends Interface {
  ...
  export interface DkgAggregatorVerifier extends BaseContract {
    
    connect(runner?: ContractRunner | null): DkgAggregatorVerifier;
    waitForDeployment(): Promise<this>;

    interface: DkgAggregatorVerifierInterface;
